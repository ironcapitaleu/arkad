...
- Generally, there should be **one assert per test function**. If a function has multiple behaviors, consider splitting it into smaller functions or writing multiple tests.
