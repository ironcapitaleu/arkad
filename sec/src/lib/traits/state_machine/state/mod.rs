...
mod tests {
    ...
    #[test]
    const fn should_implement_auto_traits_for_sample_sec_state() {
    ...
    #[test]
    const fn should_implement_send_for_sample_sec_state() {
        implements_send::<SampleSecState>();
    }

    #[test]
    const fn should_implement_sync_for_sample_sec_state() {
        implements_sync::<SampleSecState>();
    }

    #[test]
    const fn should_be_thread_safe_for_sample_sec_state() {
        implements_send::<SampleSecState>();
        implements_sync::<SampleSecState>();
    }
    ...
    #[test]
    const fn should_be_sized_for_sample_sec_state() {
        implements_sized::<SampleSecState>();
    }

    const fn implements_hash<T: Hash>() {}
    #[test]
    const fn should_implement_hash_for_sample_sec_state() {
        implements_hash::<SampleSecState>();
    }

    const fn implements_partial_eq<T: PartialEq>() {}
    #[test]
    const fn should_implement_partial_eq_for_sample_sec_state() {
        implements_partial_eq::<SampleSecState>();
    }

    const fn implements_eq<T: Eq>() {}
    #[test]
    const fn should_implement_eq_for_sample_sec_state() {
        implements_eq::<SampleSecState>();
    }

    const fn implements_partial_ord<T: PartialOrd>() {}
    #[test]
    const fn should_implement_partial_ord_for_sample_sec_state() {
        implements_partial_ord::<SampleSecState>();
    }

    const fn implements_ord<T: Ord>() {}
    #[test]
    const fn should_implement_ord_for_sample_sec_state() {
        implements_ord::<SampleSecState>();
    }

    const fn implements_default<T: Default>() {}
    #[test]
    const fn should_implement_default_for_sample_sec_state() {
        implements_default::<SampleSecState>();
    }

    const fn implements_debug<T: Debug>() {}
    #[test]
    const fn should_implement_debug_for_sample_sec_state() {
        implements_debug::<SampleSecState>();
    }

    const fn implements_clone<T: Clone>() {}
    #[test]
    const fn should_implement_clone_for_sample_sec_state() {
        implements_clone::<SampleSecState>();
    }

    const fn implements_unpin<T: Unpin>() {}
    #[test]
    const fn should_implement_unpin_for_sample_sec_state() {
