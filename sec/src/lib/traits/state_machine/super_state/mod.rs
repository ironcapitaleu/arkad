...
mod tests {
    ...
    #[test]
    const fn should_implement_auto_traits_for_sample_sec_super_state() {
        implements_auto_traits::<SampleSecSuperState<SampleSecState>>();
    }

    const fn implements_send<T: Send>() {}
    #[test]
    const fn should_implement_send_for_sample_sec_super_state() {
        implements_send::<SampleSecSuperState<SampleSecState>>();
    }

    const fn implements_sync<T: Sync>() {}
    #[test]
    const fn should_implement_sync_for_sample_sec_super_state() {
        implements_sync::<SampleSecSuperState<SampleSecState>>();
    }

    const fn implements_sized<T: Sized>() {}
    #[test]
    const fn should_be_sized_for_sample_sec_super_state() {
        implements_sized::<SampleSecSuperState<SampleSecState>>();
    }

    const fn implements_hash<T: Hash>() {}
    #[test]
    const fn should_implement_hash_for_sample_sec_super_state() {
        implements_hash::<SampleSecSuperState<SampleSecState>>();
    }

    const fn implements_partial_eq<T: PartialEq>() {}
    #[test]
    const fn should_implement_partial_eq_for_sample_sec_super_state() {
        implements_partial_eq::<SampleSecSuperState<SampleSecState>>();
    }

    const fn implements_eq<T: Eq>() {}
    #[test]
    const fn should_implement_eq_for_sample_sec_super_state() {
        implements_eq::<SampleSecSuperState<SampleSecState>>();
    }

    const fn implements_partial_ord<T: PartialOrd>() {}
    #[test]
    const fn should_implement_partial_ord_for_sample_sec_super_state() {
        implements_partial_ord::<SampleSecSuperState<SampleSecState>>();
    }

    const fn implements_ord<T: Ord>() {}
    #[test]
    const fn should_implement_ord_for_sample_sec_super_state() {
        implements_ord::<SampleSecSuperState<SampleSecState>>();
    }

    const fn implements_debug<T: Debug>() {}
    #[test]
    const fn should_implement_debug_for_sample_sec_super_state() {
        implements_debug::<SampleSecSuperState<SampleSecState>>();
    }

    const fn implements_clone<T: Clone>() {}
    #[test]
    const fn should_implement_clone_for_sample_sec_super_state() {
        implements_clone::<SampleSecSuperState<SampleSecState>>();
    }

    const fn implements_unpin<T: Unpin>() {}
    #[test]
    const fn should_implement_unpin_for_sample_sec_super_state() {
