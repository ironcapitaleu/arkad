...
/// to leave headroom for clock skew and network jitter (see the STA-124 findings). Used as the
/// replenish interval of the leaky-bucket quota, which implies a burst size of one.
