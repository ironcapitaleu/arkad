...
mod tests {
    ...
    #[test]
    const fn should_implement_auto_traits_for_parse_company_facts_output() {
    ...
    #[test]
    const fn should_implement_send_for_parse_company_facts_output() {
        implements_send::<ParseCompanyFactsOutput>();
    }

    #[test]
    const fn should_implement_sync_for_parse_company_facts_output() {
        implements_sync::<ParseCompanyFactsOutput>();
    }

    #[test]
    const fn should_be_thread_safe_for_parse_company_facts_output() {
        implements_send::<ParseCompanyFactsOutput>();
        implements_sync::<ParseCompanyFactsOutput>();
    }
    ...
    #[test]
    const fn should_be_sized_for_parse_company_facts_output() {
        implements_sized::<ParseCompanyFactsOutput>();
    }

    const fn implements_hash<T: Hash>() {}
    #[test]
    const fn should_implement_hash_for_parse_company_facts_output() {
        implements_hash::<ParseCompanyFactsOutput>();
    }

    const fn implements_partial_eq<T: PartialEq>() {}
    #[test]
    const fn should_implement_partial_eq_for_parse_company_facts_output() {
        implements_partial_eq::<ParseCompanyFactsOutput>();
    }

    const fn implements_eq<T: Eq>() {}
    #[test]
    const fn should_implement_eq_for_parse_company_facts_output() {
        implements_eq::<ParseCompanyFactsOutput>();
    }

    const fn implements_partial_ord<T: PartialOrd>() {}
    #[test]
    const fn should_implement_partial_ord_for_parse_company_facts_output() {
        implements_partial_ord::<ParseCompanyFactsOutput>();
    }

    const fn implements_ord<T: Ord>() {}
    #[test]
    const fn should_implement_ord_for_parse_company_facts_output() {
        implements_ord::<ParseCompanyFactsOutput>();
    }

    const fn implements_debug<T: Debug>() {}
    #[test]
    const fn should_implement_debug_for_parse_company_facts_output() {
        implements_debug::<ParseCompanyFactsOutput>();
    }

    const fn implements_clone<T: Clone>() {}
    #[test]
    const fn should_implement_clone_for_parse_company_facts_output() {
        implements_clone::<ParseCompanyFactsOutput>();
    }

    const fn implements_unpin<T: Unpin>() {}
    #[test]
    const fn should_implement_unpin_for_parse_company_facts_output() {
