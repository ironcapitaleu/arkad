...
mod tests {
    ...
    #[test]
    const fn should_be_able_to_rely_on_auto_traits_when_using_fake_read_write_repository() {
    ...
    #[test]
    const fn should_implement_send_when_using_fake_read_write_repository() {
        implements_send::<FakeReadWriteRepository<String>>();
    }

    #[test]
    const fn should_implement_sync_when_using_fake_read_write_repository() {
        implements_sync::<FakeReadWriteRepository<String>>();
    }

    #[test]
    const fn should_be_thread_safe_when_using_fake_read_write_repository() {
        implements_send::<FakeReadWriteRepository<String>>();
        implements_sync::<FakeReadWriteRepository<String>>();
    }
    ...
    #[test]
    const fn should_be_able_to_rely_on_being_sized_when_using_fake_read_write_repository() {
        implements_sized::<FakeReadWriteRepository<String>>();
    }

    const fn implements_debug<T: Debug>() {}
    #[test]
    const fn should_be_able_to_rely_on_debug_when_using_fake_read_write_repository() {
        implements_debug::<FakeReadWriteRepository<String>>();
    }

    const fn implements_default<T: Default>() {}
    #[test]
    const fn should_be_able_to_rely_on_default_when_using_fake_read_write_repository() {
